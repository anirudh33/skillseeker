...
CREATE TABLE `test_details` (
  ...
  `created_on` datetime DEFAULT NULL,
  `updated_on` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' ON UPDATE CURRENT_TIMESTAMP,
  `negative_marks` enum('0','1') DEFAULT '0' COMMENT '0 - no negative marks,1- negative marking',
  PRIMARY KEY (`id`),
  KEY `test_id` (`test_id`),
...
INSERT INTO `test_details` VALUES (1,1,NULL,1,NULL,'1',0,3,'http://www.skillseeker.com/online-test/start/?id=1&time=132568852','1',NULL,'S','1',1,1,'0',NULL,'1',NULL,'2013-06-10 03:30:23','0'),(3,2,'2013-05-24 12:00:00',60,'avni.jain@osscube.com','1',50,1,'http://www.skillseeker.com/online-test/start/?id=xIF0j_8-521SRcE3nuCOqauPjj02dzvuID3gH-Q7raE&time=8vxeLoV5vwiIKGa-bo2Ec9rBsvaCTBsGfOf4H08rqBk','1','2013-05-24 12:10:00','R','1',4,3,'1',NULL,'','2013-05-24 04:28:05','0000-00-00 00:00:00','0');
...
-- Dump completed on 2013-06-12 12:32:20
