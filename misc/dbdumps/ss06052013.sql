...
CREATE TABLE `question_answer` (
  ...
  KEY `answer` (`answer`),
  CONSTRAINT `question_answer_ibfk_2` FOREIGN KEY (`answer`) REFERENCES `options` (`id`),
  CONSTRAINT `question_answer_ibfk_1` FOREIGN KEY (`question_id`) REFERENCES `question_bank` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2013-05-06 13:32:54
